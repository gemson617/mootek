                    ...
                    <div class="card border-left-primary shadow h-100 ">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    <input type="hidden" name="table" value="payment_status" />
                                    <div class="col-md-4">
                                        <label for="">Payment Status<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" placeholder="Payment Status" id='payment_status' class="form-control txt-num @error('payment_status') is-invalid @enderror" name="payment_status" />
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form "><i class="fa fa-edit"></i></a>
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="payment_status" class='btn btn-info change'>status</button></td>
...
<script>
        ...
        messages: {
            payment_status: 'This Payment Status is Required',
            ...
            $.ajax({
                ...
                success: function(data) {   
                    if(data != 1){
                        ...
                        $("#payment_status").val(row.payment_status);
                        $("#status").val(row.status).select2();     
                        $("#id").val(row.id);           
                        $(".card-title").html('Edit Payment Status').css('color','blue');                  
