                ...
                <div class="col-sm-12">
                    <div class="card border-left-primary shadow h-100 ">
                        <div class="card-header">
                            <h3 class="card-title">Transaction Mode</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="">Transaction Mode<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" placeholder="Transaction Mode" id='transaction_mode' class="form-control txt-num @error('transaction_mode') is-invalid @enderror" name="transaction_mode" />
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form "><i class="fa fa-edit"></i></a>
                                ...
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="Transaction" class='btn btn-info change'>status</button>
                            </td>
                        </tr>
                        <?php $i++; }  } ?>
                    </tbody>
...
<script>
        ...
        messages: {
            transaction_mode: 'This Transaction Mode is Required',
            ...
            $.ajax({
                ...
                success: function(data) {   
                    if(data != 1){
                        ...
                        $("#transaction_mode").val(row.transaction_mode);
                        $("#status").val(row.status).select2();     
                        $("#id").val(row.id);           
                        $(".card-title").html('Transaction Mode').css('color','blue');                  
