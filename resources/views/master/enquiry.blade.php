                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="">Enquiry Name<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" placeholder="Enquiry Name" id='enquiry_name' class="form-control txt-num @error('enquiry_name') is-invalid @enderror" name="enquiry_name" />
                                            @error('enquiry_name')
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form"><i class="fa fa-edit"></i></a>
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="Enquiry" class='btn btn-info change'>status</button></td>
...
<script>
  $(".change").click(function(){    
        ...
        messages: {
            enquiry_name: 'This Enquiry Name  is Required',
            ...
            $.ajax({
                ...
                success: function(data) {   
                    if(data != 1){
                        ...
                        $("#enquiry_name").val(row.enquiry_name);
