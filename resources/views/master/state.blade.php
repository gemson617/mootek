                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="">State Name<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" placeholder="State Name" id='state_name' class="form-control txt-num @error('state_name') is-invalid @enderror" name="state_name" />
                                            @error('state_name')
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form"><i class="fa fa-edit"></i></a>
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="states" class='btn btn-info change'>status</button></td>
...
<script>
  $(".change").click(function(){    
        ...
        messages: {
            state_name: 'This State Name is Required',
