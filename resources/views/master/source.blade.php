                ...
                <div class="col-sm-12">
                    <div class="card border-left-primary shadow h-100 ">
                        <div class="card-header">
                            <h3 class="card-title">Source Management</h3>
                        </div>
                        <div class="card-body">
                            @if (session('msg'))
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    <input type="hidden" name="table" value="Source" />
                                    <div class="col-md-4">
                                        <label for="">Source Name<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" placeholder="Source Name" id='source_name' class="form-control txt-num @error('source_name') is-invalid @enderror" name="source_name" />
                                            @error('source_name')
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form"><i class="fa fa-edit"></i></a>
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="source" class='btn btn-info change'>status</button></td>
...
<script>
  $(".change").click(function(){    
        ...
        messages: {
            source_name: 'This Source Name  is Required',
