                ...
                <div class="col-sm-12">
                    <div class="card border-left-primary shadow h-100 ">
                        <div class="card-header">
                            <h3 class="card-title">Enquiry Category</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <input type="hidden" name="table" value="enquiry_category" />
                                <div class="row">
                                        
                                    <div class="col-md-4">
                                        <label for="">Enquiry Category Name<span class="error">*</span></label>

                                        <div class="form-group">
                                            <input type="Text" id='category_name' class="form-control txt-num @error('category_name') is-invalid @enderror" name="category_name" placeholder="Enquiry Category Name" />
                                            @error('category_name')
                ...
                <table id="datatable" class='table table-striped'>
                    ...
                    <tbody>
                       ...
                       <td><button value='{{$val->id}}'  class='btn btn-primary edit_form'><i class="fa fa-edit"></i></button>
                        <button value='{{$val->id}}' data="{{$val->status}}" data-name="enquiry_category" class='btn btn-info change'>status</button>
