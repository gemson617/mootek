                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="">Status Name<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" id='status_name' class="form-control txt-num @error('status_name') is-invalid @enderror" name="status_name" />
                                            @error('status_name')
...
$('form[id="form"]').validate({
        ...
        messages: {
            status_name: 'This Status Name is Required',
            ...
            $.ajax({
                ...
                success: function(data) {   
                    if(data != 1){
                        ...
                        $("#status_name").val(row.status_name);
