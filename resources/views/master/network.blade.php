                ...
                <div class="col-sm-12">
                    <div class="card border-left-primary shadow h-100 ">
                        <div class="card-header">
                            <h3 class="card-title">Network Master With Monthly Price</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    <input type="hidden" name="table" value="Network" />
                                    <div class="col-md-4">
                                        <label for="">Network Name<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" id='network_name' class="form-control txt-num @error('network_name') is-invalid @enderror" name="network_name" placeholder="Network Name" />
                                            @error('network_name')
                                    ...
                                    <div class="col-md-4">
                                        <label for="">Network Monthly Price<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" id='network_monthly_price' class="form-control txt-num @error('network_monthly_price') is-invalid @enderror" name="network_monthly_price" placeholder="Network Monthly Price" />
                                            @error('network_monthly_price')
                                        <div class="error">*{{$message}}</div>
                                        @enderror
                                        </div>
                                    </div>
                    ...
                    <tbody>
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><?= $val->network_monthly_price ?></td>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form "><i class="fa fa-edit"></i></a>
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="Network" class='btn btn-info change'>status</button></td>
...
<script>
        ...
        rules: {
            ...
            network_monthly_price: 'required',
            status: 'required',
        },
        messages: {
            network_name: 'This Network Name is Required',
            network_monthly_price: 'This Network Monthly Price  is Required',
            ...
            $.ajax({
                ...
                success: function(data) {   
                    if(data != 1){
                        ...
                        console.log(row);                    
                        $("#network_name").val(row.network_name);
                        $("#network_monthly_price").val(row.network_monthly_price);
