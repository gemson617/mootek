                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="Text" placeholder="Role Name" id='role_name' class="form-control txt-num @error('role_name') is-invalid @enderror" name="role_name" />
                                            @error('role_name')
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form "><i class="fa fa-edit"></i></a>
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="Role" class='btn btn-info change'>status</button></td>
...
<script>
        ...
        messages: {
            role_name: 'This Role Name is Required',
            ...
            $.ajax({
                ...
                success: function(data) {   
                    if(data != 1){
                        ...
                        $("#id").val(row.id);           
                        $(".card-title").html('Role Master').css('color','blue');                  
                        $("#role_name").focus();
                        scrollToTop();
                    }               
                },
