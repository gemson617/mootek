                ...
                <div class="col-sm-12">
                    <div class="card border-left-primary shadow h-100 ">
                        <div class="card-header">
                            <h3 class="card-title">HSN Code</h3>
                        </div>
                        <div class="card-body">
                            @if (session('msg'))
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    <input type="hidden" name="table" value="HSN" />
                                    <div class="col-md-4">
                                        <label for="">HSN Code<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="number" id='hsn_code' class="form-control txt-num @error('hsn_code') is-invalid @enderror" name="hsn_code" placeholder="HSN"/>
                                            @error('hsn_code')
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form"><i class="fa fa-edit"></i></a>
                                ...
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="HSN" class='btn btn-info change'>status</button>
                            </td>
                        </tr>
                        <?php $i++; }  } ?>
                    </tbody>
...
<script>
  $(".change").click(function(){    
        ...
        messages: {
            hsn_code: 'This HSN Code is Required',
            ...
            $.ajax({
                ...
                success: function(data) {   
                    if(data != 1){
                        ...
                        $("#id").val(row.id);           
                        $(".card-title").html('HSN Status').css('color','blue');                  
                        $("#hsn_code").focus();
                        scrollToTop();
                    }               
                },
