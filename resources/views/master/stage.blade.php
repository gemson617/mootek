                ...
                <div class="col-sm-12">
                    <div class="card border-left-primary shadow h-100 ">
                        <div class="card-header">
                            <h3 class="card-title">Add Stage</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    <input type="hidden" name="table" value="Stage" />
                                    <div class="col-md-4">
                                        <label for="">Stage Name<span class="error">*</span></label>
                                        <div class="form-group">
                                            <input type="Text" id='stage_name' class="form-control txt-num @error('stage_name') is-invalid @enderror" name="stage_name" />
                                            @error('stage_name')
...
$(".change").click(function(){    
        ...
        messages: {
            stage_name: 'This Stage name   is Required',
            ...
            $.ajax({
                ...
                console.log(data);   
                    if(data != 1){
                        ...
                        $("#stage_name").val(row.stage_name);
                        $("#status").val(row.status).select2();     
                        $("#id").val(row.id);           
                        $(".card-title").html('Edit Status').css('color','blue');                  
                        $("#stage_name").focus();
                        scrollToTop();
                    }               
                },
