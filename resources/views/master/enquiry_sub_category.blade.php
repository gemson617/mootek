                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{route('status.storeStatus')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="">Select Enquiry Category<span class="error"> * </span><a class="fa fa-plus-circle" href="/enquiry_categories"></a></label>
                ...
                <table id="datatable" class='table table-striped'>
                    ...
                    <tbody>
                       ...
                       <td><button value='{{$val->id}}'  class='btn btn-primary edit_form'><i class="fa fa-edit"></i></button>
                        <button value='{{$val->id}}' data="{{$val->status}}" data-name="enquiry_sub_category" class='btn btn-info change'>status</button>
                       <button value='{{$val->id}}'  class='btn btn-danger delete_modall'><i class="fa fa-trash"></i></button></td>
                        </tr>
                        @endforeach
...
<script>
        ...
        messages: {
            ...
            customer_cat_id: 'This Enquiry Category is required',
    ...
    $(document).ready(function() {
        ...
        id=$(this).val();
        var table='enquiry_sub_category';
