                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="Text" placeholder="Payment Mode" id='payment_mode' class="form-control txt-num @error('payment_mode') is-invalid @enderror" name="payment_mode" />
                                            @error('payment_mode')
                       ...
                       <?php if(isset($status)){ 
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" data-id="<?= $val->id ?>" class="btn btn-primary edit_form "><i class="fa fa-edit"></i></a>
                                <button value='{{$val->id}}' data="{{$val->status}}" data-name="Payment" class='btn btn-info change'>status</button></td>
...
<script>
        ...
        messages: {
            payment_mode: 'This Payment Mode is Required',
