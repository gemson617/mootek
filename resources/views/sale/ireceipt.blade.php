...
<body style='padding :5% !important;border:1px solid black;'>
    ...
    $details = App\Models\company::where('id', Auth::user()->companyID)->first();
    ?>

    <table width="100%">
        <tr width='100%'>
            <td align="left" style="width:50%;">
                <span> Email ID : <?php echo  $purchase_details->company; ?></span><br>
                <span> Address : <?php echo  $purchase_details->address_line1 . '<br>' . $purchase_details->address_line2; ?> </span><br>
                <span> Phone No : <?php echo $purchase_details->phone_number; ?></span><br>
                <span> Email ID : <?php echo  $purchase_details->email; ?></span><br>
            </td>
    ...
    <table width='100%'>
        <tr width='100%'>
            <td align="left" style="width:50%;">No : <?php echo  $history->invoiceNo;  ?> </td>
            <?php
    ...
    <table>
        <tr>
            <td style="width:70%">
                <p style="text-indent: 50px">Received with thanks from <span style="text-decoration: underline;"><?= $purchase_details->name; ?> </span>&nbsp;&nbsp;&nbsp;Rupees 
