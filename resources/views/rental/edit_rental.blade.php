...
<div class="content-wrapper">
	   <div id="snackbar"></div>
			<div class="content container">
                ...
                <form id="editrental" method="post" action="{{route('rental.edit_rental_store')}}">
                    @csrf
                    <div class="card">
                        <h7 class="card-header">Edit RENTAL</h7>
                            ...
                            <div class="row ">
                                    <input type="hidden" id='rent_id' name='rent_id' value="{{$data->rentalID}}">
                                            ...
                                            <div class="col-md-3 mb-3">
													...
													<input type="date" value="{{$data->rental_date}}" class="form-control   @error('rent_date') is-invalid @enderror" id="rent_date" name="rent_date" placeholder=""  >
                                                @error('rent_date')
                                                <div class="error">*{{$message}}</div>
                                                @enderror
											</div>
                                            ...
                                            <div class="col-md-2 mb-3">
                                                    ...
                                                    <option value="Weeek"  <?php echo 'Week' == $data->day_week_month ?'selected':' ' ?> >Weeek</option>
                                            ...
                                            <div class="col-md-2 mb-3" style="width: 12.499999995%">
                                                ...
                                                <select  class="form-select @error('rent_month') is-invalid @enderror" onchange="calculatemoth()" id="rent_month" name="rent_month" placeholder=""  >
                                                    ...
                                                    @endfor
                                                    @elseif($data->day_week_month == 'Week')
                                                    @for ($i = 1; $i <= 7; $i ++)
                                            ...
                                            <input type="hidden" id='id{{$p_key}}' name='id[]' value="{{$p_val->rp_id}}">
												<div class="col-md-4 mb-3">
                                                    ...
                                                    ?>
                                                        ...
                                                        <option title="{{$product->description}}" value="{{$p_val->id}}|{{$p_val->categoryID}}|{{$brand->id}}|{{$product->id}}">{{$brand->brand_name}}-{{$product->productName}}</option>
                                                            </select>
