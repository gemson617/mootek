            ...
            <form id="purchase" method="post" action="{{ route('add.purchase') }}">
                                ...
                                @endif
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="validationCustomUsername">Invoice No<span class="error">*</span></label>
                                            <input type="text"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="validationCustomUsername">AWB No<span class="error">*</span></label>
                                            <input type="text"
                                                class="form-control @error('awb_no') is-invalid @enderror"
                                                id="awb_no" name="awb_no" placeholder="Enter AWB No">
                                            @error('awb_no')
                                                <div class="error">*{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="validationCustomUsername">Reference No<span class="error">*</span></label>
                                            <input type="text"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="validationCustomUsername">Duty Slip No<span class="error">*</span></label>
                                            <input type="text"
                                                class="form-control @error('slip_no') is-invalid @enderror"
                                                id="slip_no" name="slip_no" placeholder="Enter Reference No">
                                            @error('slip_no')
                                                <div class="error">*{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row" id="purform">
                                        ...
                                        <div class="col-md-3 mb-3 serialcol"  id="serialcol">
                                        ...
                                        <div class="col-md-2 mb-3 qtycol"  id="qtycol">
