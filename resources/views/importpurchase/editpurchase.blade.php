...
<style>
    ...
    <div class="content-wrapper">
        ...
        <div class="content container">
            ...
            <form id="purchase" method="post" action="{{ route('importpurchase.update') }}">
                                    @csrf
                                <div class="card">
                                ...
                                @endif
                                        <div class="row pb-2">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-select @error('supplierID') mode is-invalid @enderror"
                                                    ...
                                                    <option value="" >--Select--</option>
                                                        <option value="air" <?= $import->mode=='air'?'selected':''; ?>>AIR</option>
                                                        <option value="ship" <?= $import->mode=='ship'?'selected':''; ?>>SHIP</option>
    
                                                </select>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="validationCustomUsername">Select Import Purchase Bill<span class="error">*</span></label>
                                                <select class="form-select @error('supplierID') import_purchase is-invalid @enderror"
                                                    ...
                                                    @foreach ($import_purchase as $sdata)
                                                        <option value="{{ $sdata->id }}" <?= $import->import_purchase==$sdata->id?'selected':''; ?>>{{ $sdata->purchase_company }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-select @error('purchase_executive') purchase_executive is-invalid @enderror"
                                                    ...
                                                    @foreach ($purchase_executive as $sdata)
                                                        <option value="{{ $sdata->id }}" <?= $import->purchase_executive==$sdata->id?'selected':''; ?>>{{ $sdata->first_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="hidden" id="master_id" name="master_id" value="{{$import->id}}">
                                                <select class="form-select @error('purchase_role') purchase_role is-invalid @enderror"
                                                    ...
                                                    @foreach ($purchase_role as $sdata)
                                                        <option value="{{ $sdata->id }}" <?= $import->purchase_role==$sdata->id?'selected':''; ?>>{{ $sdata->role_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('purchase_role')
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td> <input type="text"
                                                        ...
                                                        id="bank" name="bank" value="{{$import->bank}}"  placeholder="Bank" ></td>
                                                    <td><input type="text"
                                                        class="form-control @error('reference_no') is-invalid @enderror"
                                                        id="reference_no" name="reference_no" value="{{$import->reference_no}}" placeholder="Reference No"></td>
                                                    <td> <input type="number"
                                                        class="form-control @error('usd') is-invalid @enderror"
                                                        id="usd" name="usd" placeholder="USD" value="{{$import->usd}}" ></td>
                                                    <td><input type="number"
                                                        class="form-control @error('inr') is-invalid @enderror"
                                                        id="inr" name="inr" placeholder="INR" value="{{$import->inr}}"></td>
                                                    <td><input type="number"
                                                        class="form-control @error('amount') is-invalid @enderror"
                                                        id="amount" name="amount" placeholder="Amount" value="{{$import->amount}}"></td>
                                                    <td><input type="number" value="{{$import->bank_fees}}"
                                        ...
                                        <div class="row pt-4 pb-2">
                                            <table>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <th>DO Charges</th>
                                                    <td> <input type="number" value="{{$import->do_charges_bill}}"
                                                    ...
                                                    <td> <input type="text" value="{{$import->do_charges_weight}}"
                                                    ...
                                                    <td><input type="number" value="{{$import->do_charges_amount}}"
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><input type="number" value="{{$import->custom_com_bill}}"
                                                    ...
                                                    <td><input type="text" value="{{$import->custom_com_weight}}"
                                                    ...
                                                    <td><input type="number" value="{{$import->custom_com_amount}}"
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><input type="text" value="{{$import->cfs_charges_bill}}"
                                                    ...
                                                    <td><input type="text" value="{{$import->cfs_charges_weight}}"
                                                    ...
                                                    <td><input type="number" value="{{$import->cfs_charges_amount}}"
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><input type="number" value="{{$import->transport_c_bill}}"
                                                    ...
                                                    <td><input type="text" value="{{$import->transport_c_weight}}"
                                                    ...
                                                    <td><input type="number" value="{{$import->transport_c_amount}}"
                                                ...
                                                <table>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <td><input type="number" value="{{$import->agent_charges}}"
                                            ...
                                            <div class="row pt-4 pb-2">
                                                <table>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                            <td><input type="text" value="{{$import->claim_details}}"
                                            ...
                                            <div class="row pt-4 pb-2">
                                                <table>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                            <td><input type="date" value="{{$import->pickup_date}}"
                                                                class="form-control @error('pickup_date') is-invalid @enderror"
                                                                id="pickup_date" name="pickup_date" placeholder="Claim Details"></td>
                                                            <td><input type="date" value="{{$import->delivery_date}}"
                                                                class="form-control @error('delivery_date') is-invalid @enderror"
                                                                id="delivery_date" name="delivery_date" placeholder="Supplier Name"></td>
                                                            <td><input type="text" value="{{$import->no_of_days}}"
                                                                class="form-control @error('days') is-invalid @enderror"
                                                                id="no_of_days" name="no_of_days" placeholder="Days"></td>       
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                            </div>
                                    ...
                                    <div class="row" id="purform">
                                        ...
                                        <div class="col-md-3 mb-3 qtycol"  id="qtycol">
                                            ...
                                            <input type="text"  value="{{$value->qty}}"
                                                ...
                                                id="qty{{$key}}" name="qty[]" placeholder="Qty">
                                        ...
                                        {{-- <div class="col-md-2 mb-3">
                                            ...
                                            <input type="number" step="any"
                                                class="form-control   @error('rate') is-invalid @enderror" value="{{$import->}}"
                                        ...
                                        <div class="col-md-2 mb-3">
                                           ...
                                           <div class="col-md-1">
                                            <i class="fa fa-trash mt-5" onclick="removediv({{$key}},{{$value->p_id}})" style="font-size:22px;color:red"></i>
                                            </div>
                                                    </div>
                                                </div>
                                                @endforeach
                                        ...
                                        <div class="col-md-12  d-flex justify-content-end">
                                            <table class="table table-bordered text-right">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="Text" id='tax_price' value="{{$local->tax_price}}" class="form-control txt-num @error('tax_price') is-invalid @enderror" value="{{$import->}}" name="tax_price" readonly />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" id='others'value="{{$local->others}}"  class="form-control txt-num @error('others') is-invalid @enderror" value="{{$import->}}" name="others" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>CESS(+)</td>
                                                    <td>
                                                        <input type="number" id='cess'value="{{$local->cess}}" oninput="cess()" class="form-control txt-num @error('cess') is-invalid @enderror" value="{{$import->}}" name="cess" />
                                                    </td>
                                                </tr>
                                                <tr id="gst_list">
                                                ...
                                                <tr>
                                                    <td>Grand Total</td>
                                                    <td>
                                                        <input type="Text" id='grand_total' value="{{$local->grand_total}}"  class="form-control txt-num @error('grand_total') is-invalid @enderror" value="{{$import->}}" name="grand_total" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                  ...
                  //  })
                    ...
                    $(".add-field", $(this)).click(function(e, count) {
                        ...
                        // alert(count);
                            ...
                            var row = $(
                            '<div class="multi-fields rtl-bc '+count+'" id="multi"> <div class="multi-field remove'+count+'"> <div class="row multidiv'+count+'" id="add_cal" style="; padding: 18px;">' +
                            '<div class="col-md-3"><label for="">Select Product<span class="error">*</span></label><div class="form-group "><select id="product' +
                           ...
                           '<div class="col-md-3"><label for="">Model No<span class="error">*</span></label><div class="form-group "><input type="text" id="model' +
                            ...
                            '<div class="col-md-2 qtycol"><label for="">Qty<span class="error">*</span></label><div class="form-group "><input type="text" id="qty' +
