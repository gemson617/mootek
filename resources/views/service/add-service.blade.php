...
<div class="app-content page-body">
    <div class="container">
        ...
        <div class="">
            <form id='sale' action="{{route('service.final_invoice')}}" method='post'>
                <div class="row">
                                ...
                                <div class="row px-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id='customer' class="form-control  @error('price') is-invalid @enderror " value="{{$customer->name}}"  name="customer" readonly />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id='tax' class="form-select txt-num  @error('customer')  is-invalid @enderror" name='tax'>
                                            ...
                                            <option value="<?php echo $tax->name; ?>" selected>GST</option>
