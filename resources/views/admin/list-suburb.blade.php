    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="page-rightheader">
                <button type="button" class="btn btn-sm btn-primary mr-1"><i class="fe fe-plus mr-2"></i><a href="{{ route('admin.suburb') }}"
                        class="text-white">Add
                        Suburbs</a></button> <button type="button" class="btn btn-sm btn-primary mr-1"><i
                    ...
                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->state }}</td>
                                <td class="text-right">
                                    <a href="view-suburb/{{$row->id}}"  class="btn btn-sm btn-primary">
                                        <i class="fa fa-eye fa-sm"></i>
                                        View
                                    </a>
                                    <a href="edit-suburb/{{$row->id}}" class="btn btn-sm btn-success">
                                        <i class="fa fa-pencil"></i>
                                        Edit
                                    </a>
                                    <a href="javascript:void(0)" onclick="delete_suburb('{{$row->id}}')" 
