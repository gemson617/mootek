    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="page-rightheader">
                <button type="button" class="btn btn-sm btn-primary mr-1"><i class="fe fe-plus mr-2"></i><a href="{{ route('admin.supplier') }}"
                        class="text-white">Add
                        Supplier</a></button> <button type="button" class="btn btn-sm btn-primary mr-1"><i
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="edit-supplier/{{$row->id}}" class="btn btn-sm btn-success">
                                        <i class="fa fa-pencil"></i>
                                        Edit
                                    </a>
                                    <a href="javascript:void(0)" onclick="delete_supplier('{{$row->id}}')" type="button"
...
function delete_supplier(id) {
    swal({
        ...
        if (willDelete) {
            $.ajax({
                type: "POST",
                url: '{{route("admin.delete-supplier")}}',
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
                },
