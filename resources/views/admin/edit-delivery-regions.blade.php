    ...
    <div class="container">
        ...
        @include('layouts.partials.menu')
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">{{ __('Edit Delivery Regions') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="{{route('admin.update-delivery-regions')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="delivery_days" value="{{ $data->delivery_days }}" class="form-control">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <select  name="dispatch_from"  class="form-control">
                                        ...
                                        <option {{ ($data->dispatch_from == $row->id) ? 'selected':''  }} value="{{ $row->id }}">{{$row->address_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-success mr-1">Save and go back to
                                        list</button>&nbsp;&nbsp;&nbsp;
                                        <a href="/list-delivery-regions" class="btn btn-sm btn-danger mr-1">Cancel</a>
                                </div>
                            </div>
                        </form>
