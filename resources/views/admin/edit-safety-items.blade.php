            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('admin.update-safety-items')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                <label for="">Item Name:<span class="error">*</span></label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <a class="btn btn-sm btn-primary mr-1" href="/list-safety-items">Back</a>
                                    <button type="submit" class="btn btn-sm btn-success mr-1">Save and go back to list</button>
                                    <a class="btn btn-sm btn-danger mr-1" href="/list-safety-items">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
