    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">{{ __('Add Classtype') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('admin.add-class-types')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="list-class-types" class="btn btn-sm btn-primary mr-1">Back</a>
