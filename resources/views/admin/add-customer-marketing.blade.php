	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-md-12">
				...
				<div class="card">					
					<div class="card-header">{{ __('Add Marketing') }}</div>
					...
					<div class="card-body">
						...
						@endif
								...
								<form method="post" action="{{ route('admin.add-marketing-customer') }}" >
									@csrf
									<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-8">
									<div class="form-group">
										<input type="text" class="form-control" name="about_agas" />
									</div>
							</div>
									</div>
									<hr>
									<div class="row">
										<div class="col-md-6">
											<a href="list-marketing-customer" class="btn btn-sm btn-primary mr-1">Back</a>
